    ...
    <>
      <div className="h-screen flex flex-row justify-center items-center">
        ...
        <div className="flex flex-col gap-7 border-b-8 w-[90vw] md:w-[30vw] min-h-[70vh] backdrop-blur-3xl p-10 m-auto border rounded-3xl shadow-lg shadow-stone-700">
          <div className="mb-10 text-center text-4xl font-bold border-foreground border-b-8 rounded-xl">
            <h1>Welcome</h1>
          </div>
          <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
            ...
            <input
              ...
              className={`w-full p-3 rounded-lg border border-gray-300 shadow-lg text-black ${
